 ...
 */
public class TacticalBattleOrder
        implements Comparator<TacticalBattleReport>, Serializable {
     ...
     */
    @Override
    public int compare(final TacticalBattleReport report1, final TacticalBattleReport report2) {
        int comparison = 0;
