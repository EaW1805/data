...
/**
 * Used to sort brigades based on their distance from the nearest trade city if in Europe, otherwise randomly if in the
 * colonies.
 */
public class BrigadePosition
        extends PositionComparator
        implements Comparator<Brigade> {
     ...
     */
    public BrigadePosition(final Game thisGame, final Random generator) {
     ...
     */
    public int compare(final Brigade brig1, final Brigade brig2) {
